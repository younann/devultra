export const translations = {
  en: {
    ...
    footer: {
      desc: 'Building digital excellence at DevUltra since 2026.',
      social: 'Social',
      links: 'Links',
  ...
  ar: {
    ...
    footer: {
      desc: 'نبني التميز الرقمي في DevUltra منذ عام 2026.',
  ...
  he: {
    ...
    footer: {
      desc: 'בונים מצוינות דיגיטלית ב-DevUltra מאז 2026.',
      social: 'מדיה חברתית',
      links: 'קישורים',
